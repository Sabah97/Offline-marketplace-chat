...
{
    product=JSON.parse(window.localStorage.getItem('row'))
}
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">\
    <div class="modal-content">\
      <div class="modal-header">\
        <div class= "row">\
        <h5 class="modal-title" id="exampleModalLongTitle">'+element.name+ '</h5>\
        </div>\
      ...
      <div class="modal-body">\
        <div class="row">\
          <img class="modal-img" src='+element.url +'>\
        </div>\
        <div class="col">\
        <h2>'+ element.description +'</h2>\
          <span class="price-item">'+element.price +'</span>\
      ...
      <div class="modal-footer">\
          <button class="btn shop-item-button" type="button"> Add to Cart <i class="fas fa-shopping-cart"></i></button>\
